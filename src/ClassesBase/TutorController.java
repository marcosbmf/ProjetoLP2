...
public class TutorController {
	...
	public void tornarTutor(Aluno aluno, String disciplina, int proficiencia) {
		Tutor novoTutor = new Tutor(aluno.getMatricula(), aluno.getNome(), aluno.getCodigoCurso(), aluno.getTelefone(),
				aluno.geteMail(), aluno.getNotaAvalicao(), disciplina, proficiencia);
