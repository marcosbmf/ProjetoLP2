...
public class Disciplina {
	...
	public Disciplina(String nome, int proficiencia) {
		if (this.stringVaziaOuNula(nome)) {
			throw new IllegalArgumentException("Erro no cadastro de disciplina: Nome da disciplina nÃ£o pode ser vazia ou nula.");
		} else if (proficiencia <= 0) {
			throw new IllegalArgumentException("Erro no cadastro de disciplina: proficiencia nÃ£o pode ser igual ou menor a 0.");
		}
		this.nome = nome;
	...
	/**
	 * Este método retorna a String que representa uma disciplina 
